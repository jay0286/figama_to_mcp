...
export function RecipeCard({ recipe, onClick }) {
  const { title, description, image, cookTime, calories, tag } = recipe;

  return (
    <button
      onClick={onClick}
      className="content-stretch flex flex-col items-start relative shrink-0 w-full cursor-pointer text-left"
    >
      {/* Image Section */}
      <div className="content-stretch flex flex-col h-[168px] items-end overflow-clip p-[16px] relative rounded-tl-[16px] rounded-tr-[16px] shrink-0 w-full">
        ...
        <div className="bg-white content-stretch flex h-[20px] items-center justify-center px-[6px] py-[10px] relative rounded-[999px] shrink-0 z-10">
      ...
      {/* Content Section */}
      <div className="bg-white content-stretch flex flex-col gap-[8px] items-start p-[16px] relative rounded-bl-[16px] rounded-br-[16px] shrink-0 w-full hover:bg-gray-50 transition-colors">
